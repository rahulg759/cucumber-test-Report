...
public class UsedCarSearchSteps {
	...
	@Given("^I navigate to the Home Page \"([^\"]*)\" of CarGuide Website$")
	public void i_navigate_to_the_Home_Page_of_CarGuide_Website(String url) {
	...
	public void the_page_title_should_match_expected_title_something(String expectedPageTitle) {
